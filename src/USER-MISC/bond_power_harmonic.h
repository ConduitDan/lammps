...
BondStyle(power_bond_harmonic,BondPowerHarmonic)

#else

#ifndef LMP_BOND_POWER_HARMONIC_H
#define LMP_BOND_POWER_HARMONIC_H

#include "bond.h"

namespace LAMMPS_NS {

class BondPowerHarmonic : public Bond {
 public:
  BondPowerHarmonic(class LAMMPS *);
  virtual ~BondPowerHarmonic();
